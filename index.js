...
const zooAnimals = [
  ...
  Use animalNames to populate and 
  return the displayNames array with only the animal name and scientific name of each animal. 
  ...
  */
  ...
  console.log("Topic2 R1", animalNames(zooAnimals));
  ...
  */
  ...
  console.log("Topic2 R2", lowerCaseNames(zooAnimals));
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const needRomance = array.filter(function(item){
      return item.population < 5;
    });
    return needRomance;
  }

  console.log("Topic2 R3", lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  console.log("Topic2 R4", USApop(zooAnimals));
...
//   }
// }
// const cube = new CubeMaker(cuboid);

// console.log("stretch", cube.cubeVolume()); 
// console.log("stretch", cube.cubeSurfaceArea()); 
